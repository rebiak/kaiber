...
import { Play, Shuffle, RotateCcw, Plus, ListOrdered, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 sm:pb-0 max-w-full no-scrollbar">
            ...
            <div className="flex items-center bg-slate-800/90 rounded-lg p-0.5 border border-slate-700/80 shrink-0">
              <button
            ...
            >
              ...
              <span className="whitespace-nowrap">{t('interleave')}</span>
            </button>
            ...
            >
              ...
              <span className="whitespace-nowrap">{t('newRoutine')}</span>
            </button>
            ...
            >
              ...
              <span className="whitespace-nowrap">{t('focusMode')}</span>
              {totalSteps > 0 && (
